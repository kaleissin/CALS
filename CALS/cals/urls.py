...
#XXX: versioning is no good
        ...
        (r'^language/(?P<lang>[-\w]+)/feature/(?P<object_id>[0-9]+)/use$', 'revert_languagefeature_description'),
        (r'^language/(?P<lang>[-\w]+)/feature/(?P<object_id>[0-9]+)/history/$', 'show_languagefeature_history'),
        (r'^language/(?P<lang>[-\w]+)/feature/(?P<object_id>[0-9]+)/history/compare$', 'compare_languagefeature_history'),
